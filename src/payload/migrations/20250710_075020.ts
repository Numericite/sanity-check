...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "tools" (
  	...
  	"description" varchar,
  	"enterprise_certifications" varchar,
  	"data_access" varchar,
  	"subcontractors" varchar,
  	"transfer_out_eu" varchar,
  	"privacy_score_saas" varchar,
  	"privacy_score_self_hosted" varchar,
  	"tool_kind" varchar,
  	"location_host_client" varchar,
  	"online_accessible_dpa" varchar,
  	"subcontractors_infra" varchar,
  	"certification_dpf" boolean,
  	"opensource" varchar,
  	"self_host_possibility" varchar,
  	"fr_documentation" varchar,
  	"dpa_compliant" varchar,
  	"subkind" varchar,
  	"rgpd_feature" varchar,
  	"transfer_supervision" varchar,
  	"enterprise_location" varchar,
  	"dpa_link" varchar,
  	"subcontractors_certifications" varchar,
  	"enterprise_european" varchar,
  	"final_users_location" varchar,
  	"actions" jsonb,
  	"location_note" jsonb,
  ...
  ALTER TABLE "tools" ADD CONSTRAINT "tools_image_link_id_media_id_fk" FOREIGN KEY ("image_link_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "tools_image_link_idx" ON "tools" USING btree ("image_link_id");
